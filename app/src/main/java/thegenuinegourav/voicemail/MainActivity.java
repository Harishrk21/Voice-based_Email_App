...
public class MainActivity extends AppCompatActivity {
    ...
    private void listen(){
        ...
        // Increase the silence duration before stopping speech input
        i.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_COMPLETE_SILENCE_LENGTH_MILLIS, 30000); // 10 seconds

        // Adjust the recognition timeout
        i.putExtra(RecognizerIntent.EXTRA_SPEECH_INPUT_POSSIBLY_COMPLETE_SILENCE_LENGTH_MILLIS, 35000); // 15 seconds
